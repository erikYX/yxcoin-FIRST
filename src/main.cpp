...
uint256 hashGenesisBlock("0x9a3149370ea97c017b3d8853abadd614c28d59a96084efb3f97c25178cd943a1");
...
//    if(nHeight < 2) // no block reward within first 2 blocks 
  //      nSubsidy = 0;
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal yxcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "YXcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	hashGenesisBlock = uint256("0x22f7c905c1e8e65d6d893d847c41fc67cd1b6381707e2d3ac13132c2ef187e46")     ;
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "2.19.2015-Vanilla Ice released after being charged in Florida burglary";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
	...
	assert(block.hashMerkleRoot == uint256("0xf9669a183222e70fa62fe86bff1931327443db42363a93fbf570dfea722951a4"));
